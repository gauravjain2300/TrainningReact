      ...
      <div>
        <nav>
          ...
          >
            ...
            <Box>
              <p style={{ color: "rgba(78, 73, 73, 0.737)" }}>
                Get great devices up to 50% off get details
              </p>
            </Box>
          ...
          >
            ...
            >
              <Button endIcon={<ArrowRight />} sx={{ color: "black" }}>
                All Categoris
              </Button>
              <TextField
                label="Search"
          ...
          >
            ...
            <Button variant="text" size="small" startIcon={<Whatshot />}>
              Hot Deals
            </Button>
            <Button variant="text" size="small" endIcon={<ArrowDropDown />}>
              Home
            </Button>
            <Button variant="text" size="small" endIcon={<ArrowDropDown />}>
              About
            ...
            >
              <Icon>
                <Headphones sx={{ color: "blueviolet", fontSize: "25px" }} />
              </Icon>
